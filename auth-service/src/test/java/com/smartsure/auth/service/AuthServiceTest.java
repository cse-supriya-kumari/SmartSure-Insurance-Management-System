...
class AuthServiceTest {
    ...
    void testRegister_success_customer() {
        ...
        // Match the user object better in the mock
    ...
    void testRegister_fail_admin() {
        ...
        assertThrows(com.smartsure.auth.exception.InvalidOperationException.class, 
                     ...
                     "Registration as ADMIN is not allowed");
    }

    @Test
    void testRegister_defaultToCustomer_onInvalidRole() {
        RegisterRequest request = RegisterRequest.builder()
        ...
        when(userRepository.existsByEmail("invalid@role.com")).thenReturn(false);
        when(passwordEncoder.encode(anyString())).thenReturn("encoded_password");
